...
### 🛠️ Agile Development
- Built across 5 agile epics using Scrum methodology
- Team roles rotated weekly (Scrum Master, Developer, Tester)
- Project tracked via Jira
- Delivered and demoed as a fully functional platform
...
- Student search by name, major, or university  
- Language settings & notification controls  
- Important links (e.g., privacy policy)
